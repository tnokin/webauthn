...
exports.verifySafetyNetAttestation = (webAuthnResponse) => {
  
  console.log("verifySafetyNetAttestation(): entering with webAuthnResponse", webAuthnResponse)
  ...
  console.log("verifySafetyNetAttestation(): attestationStruct is", attestationStruct)
  ...
  console.log("verifySafetyNetAttestation(): HEADER is", HEADER)
  console.log("verifySafetyNetAttestation(): PAYLOAD is", SIGNATURE)
  console.log("verifySafetyNetAttestation(): SIGNATURE is", SIGNATURE)
  
    let decodedClientData = base64url.decode(webAuthnResponse.clientDataJSON);
  console.log("verifySafetyNetAttestation(): decodedClientData is", decodedClientData)
...
/* ----- Verify signature ENDS ----- */
    ...
    const authenticatorData = parseAttestationData(attestationStruct.authData);
  console.log("verifySafetyNetAttestation(): authenticatorData is", authenticatorData)
    const publicKey = convertCOSEPublicKeyToRawPKCSECDHAKey(
        authenticatorData.COSEPublicKey
    );
  console.log("verifySafetyNetAttestation(): publicKey is", publicKey)
...
// test
//exports.verifySafetyNetAttestation(safetyNetWebAuthnSample.response)
